    ...
    <div>
        <div class="logo-wrapper logo-wrapper-center">
            <a href="index.html" data-bs-original-title="" title="">
                <img class="img-fluid for-white" src="{{ url('assets/backend/images/logo/full-white.svg') }}" alt="logo">
            </a>
            <div class="back-btn">
        ...
        <div class="logo-icon-wrapper">
            <a href="index.html">
                <img class="img-fluid main-logo" src="{{ url('assets/backend/images/logo/logo.png') }}" alt="logo">
            </a>
        </div>
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav active" href="{{ route('dashboard')}}" wire:navigate>
