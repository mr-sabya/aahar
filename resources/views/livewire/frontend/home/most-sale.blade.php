                ...
                <div
                    ...
                    <div class="list-card-image">
                        ...
                        <a href="restaurant.html">
                            <img alt="#" src="{{ url('assets/frontend/img/sales1.png') }}" class="img-fluid item-img w-100">
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="list-card-image">
                        ...
                        <div class="member-plan position-absolute"><span
                                class="badge text-bg-dark">Promoted</span></div>
                        <a href="restaurant.html">
                            <img alt="#" src="{{ url('assets/frontend/img/sales2.png') }}" class="img-fluid item-img w-100">
                        </a>
                    </div>
                    <div class="p-3 position-relative">
                        <div class="list-card-body">
                ...
                <div
                    ...
                    <div class="list-card-image">
                        ...
                        <div class="member-plan position-absolute"><span
                                class="badge text-bg-dark">Promoted</span></div>
                        <a href="restaurant.html">
                            <img alt="#" src="{{ url('assets/frontend/img/sales3.png') }}" class="img-fluid item-img w-100">
                        </a>
                    </div>
                    <div class="p-3 position-relative">
                        <div class="list-card-body">
