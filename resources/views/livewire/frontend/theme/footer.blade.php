            ...
            <div class="row">
                <aside class="col-md-4 footer-about">
                    <article class="d-flex pb-3">
                        <div><img alt="#" src="{{ url('assets/frontend/img/logo_web.png') }}" class="logo-footer me-3"></div>
                        <div>
    ...
    <div class="footer-copyright border-top py-3 bg-light">
        <div class="container d-flex align-items-center">
            ...
            <p class="text-muted mb-0 ms-auto d-flex align-items-center">
                <a href="#" class="d-block"><img alt="#" src="{{ url('assets/frontend/img/appstore.png') }}" height="40"></a>
                <a href="#" class="d-block ms-3"><img alt="#" src="{{ url('assets/frontend/img/playmarket.png') }}" height="40"></a>
            </p>
        </div>
    </div>
</footer>